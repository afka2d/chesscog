#!/usr/bin/env python3
"""
Debug IMG_4755 using matplotlib for better macOS compatibility.
"""
...
def display_image_with_grid_matplotlib(image_path):
    ...
    # Set title
    ax.set_title('IMG_4755 - Click corners in order: a8, h8, h1, a1', fontsize=14)
    ax.axis('off')
...
def main():
    ...
    print("🔍 Debugging IMG_4755 - Matplotlib Version")
    print("=" * 60)
