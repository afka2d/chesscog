#!/usr/bin/env python3
"""
Test script to evaluate the ResNet model accuracy on the test dataset.
"""
...
def test_resnet_model_accuracy():
    """Test the ResNet model accuracy on the test dataset."""
    
    print("=== Testing ResNet Model Accuracy ===")
    
    # Load configuration
    config = CN.load_yaml_with_base('config/piece_classifier/ResNet.yaml')
...
if __name__ == "__main__":
    accuracy = test_resnet_model_accuracy()
