#!/usr/bin/env python3
"""
Fix misplaced pieces in white_rook directory based on user feedback.
"""
...
def main():
    # User-reported issues in white_rook directory
    issues = [
        # (image_name, square, issue_type, correct_piece)
        ("NEW_20250805_135338_000", "e1", "blank", None),
        ("NEW_20250805_135338_001", "e1", "blank", None),
        ("NEW_20250805_135338_001", "e3", "blank", None),
        ("NEW_20250805_135338_002", "f1", "blank", None),
        ("NEW_20250805_135338_003", "d1", "blank", None),
        ("NEW_20250805_135338_003", "f4", "blank", None),
        ("NEW_20250805_135338_004", "h1", "blank", None),
        ("NEW_20250805_135338_005", "d1", "blank", None),
        ("NEW_20250805_135338_005", "f4", "blank", None),
        ("NEW_20250805_135338_006", "a1", "blank", None),
        ("NEW_20250805_135338_006", "f4", "blank", None),
        ("NEW_20250805_135338_006", "h1", "blank", None),
        ("NEW_20250805_135338_007", "d1", "wrong_piece", "Q"),  # white queen
        ("NEW_20250805_135338_007", "h1", "blank", None),
        ("NEW_20250805_135338_009", "a1", "blank", None),
        ("NEW_20250805_135338_009", "f1", "blank", None),
        ("NEW_20250805_135338_012", "d1", "blank", None),
        ("NEW_20250805_135338_013", "e1", "blank", None),
    ]
    ...
    print("🔍 Fixing misplaced pieces in white_rook directory...")
    ...
    for image_name, square, issue_type, correct_piece in issues:
        ...
        if issue_type == "blank":
            ...
            if correct_piece == "Q":  # white queen
