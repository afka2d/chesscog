#!/usr/bin/env python3
"""
Final accuracy evaluation that measures the 4 specific metrics you requested.
"""
...
def detect_corners(image_path):
    """Detect chessboard corners with error handling"""
    try:
        ...
        logger.error(f"Error detecting corners for {image_path}: {e}")
        return None
...
def main():
    ...
    print("Final Chess Model Accuracy Evaluation")
    print("=" * 50)
    ...
    print(f"\nDetailed results saved to: final_accuracy_results.json")
