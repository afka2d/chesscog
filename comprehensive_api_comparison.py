...
Tests both APIs on grey background dataset and provides framework for Marshall dataset.
"""
...
def load_grey_background_test_data(num_images=20):
...
def save_detailed_results(original_results, marshall_results, dataset_name):
    """Save detailed results to a JSON file."""
    results_file = f"api_comparison_{dataset_name}_results.json"
...
def main():
    ...
    # Load test data
    print("\n📸 Loading test data...")
    grey_test_data = load_grey_background_test_data(num_images=20)
    ...
    save_detailed_results(original_results, marshall_results, "grey_background")
