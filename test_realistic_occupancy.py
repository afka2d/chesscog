...
def test_realistic_occupancy():
    """Test with realistic occupancy patterns."""
    print("🎯 Testing Realistic Occupancy Detection")
    print("=" * 50)
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if occupied_count == 64:
                print("   ⚠️  All squares detected as occupied - occupancy detection may need tuning")
            elif occupied_count < 20:
                print("   ✅ Realistic occupancy detection working")
            else:
                print("   ⚠️  High occupancy - may be detecting too many squares")
