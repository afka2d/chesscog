#!/usr/bin/env python3
"""
Main API with the original working occupancy detection from commit 1a3ad4be20d9862fb78620d94096b7290cc94d7f
and king piece classifier for testing.
"""
...
app = FastAPI(
    title="Chess Position Scanner API - Original Working Occupancy + Kings",
    description="API for recognizing chess positions with original working occupancy detection and king piece classification for testing.",
    version="1.0.0"
)
...
async def health_check():
    return JSONResponse(content={
        "status": "healthy - Original Working Occupancy + Kings",
