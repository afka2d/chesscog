#!/usr/bin/env python3
"""
Simple accuracy test for Marshall occupancy model
"""
...
def test_marshall_occupancy_simple():
    """Test Marshall occupancy model with simple approach"""
    logger.info("🧪 Testing Marshall Occupancy Model - Simple Test")
    logger.info("=" * 60)
...
def main():
    ...
    results = test_marshall_occupancy_simple()
