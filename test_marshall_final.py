#!/usr/bin/env python3
"""
Final comprehensive test of Marshall occupancy model
Loads original model architecture and applies Marshall weights
"""
...
def test_marshall_occupancy_final():
    """Test Marshall occupancy model with proper model loading"""
    logger.info("🧪 Testing Marshall Occupancy Model - Final Test")
    logger.info("=" * 60)
...
def main():
    ...
    logger.info("🔍 MARSHALL MODEL FINAL REAL-WORLD ACCURACY TEST")
    logger.info("=" * 70)
    logger.info("Testing Marshall occupancy model on unseen real-world data")
    logger.info("Using proper model architecture + Marshall weights")
    logger.info("=" * 70)
    
    results = test_marshall_occupancy_final()
