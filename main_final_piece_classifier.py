#!/usr/bin/env python3
"""
Final API with working occupancy detection + color classification + piece type classification.
This combines all the working components into a complete chess position recognition system.
"""
...
app = FastAPI(
    title="Chess Position Scanner API - Complete System",
    description="API with working occupancy detection + color classification + piece type classification.",
    version="1.0.0"
)
...
async def startup_event():
    logger.info("Starting up Chess Position Scanner API - Complete System...")
    ...
    logger.info("Complete system startup completed successfully")
