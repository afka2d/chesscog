#!/usr/bin/env python3
"""
Replace pieces for NEW_20250805_135338_011 with the newly extracted ones.
"""
...
def main():
    """Replace pieces for NEW_20250805_135338_011."""
    print("🔧 REPLACING PIECES FOR NEW_20250805_135338_011")
    print("=" * 50)
    
    image_name = "NEW_20250805_135338_011"
    dataset_type = "test"
    extract_dir = "re_extracted_NEW_20250805_135338_011"
        ...
        if piece_file.endswith('.png'):
            ...
            if square_name in piece_positions:
                ...
                if os.path.exists(target_path):
                    backup_path = target_path + ".backup_fen_fix"
    ...
    print(f"\n🎉 NEW_20250805_135338_011 pieces replacement complete!")
